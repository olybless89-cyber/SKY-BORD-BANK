...
const CARDS = [
  ...
  { name: 'Skyboard Prestige', tier: 'Premium', color: 'from-primary to-[#013d36]', features: ['4% dining cashback', '3% travel cashback', '2% grocery cashback', 'Airport lounge access', 'Concierge service'], featured: true },
