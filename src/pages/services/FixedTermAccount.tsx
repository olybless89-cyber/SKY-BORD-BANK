      ...
      <section className="py-20 section-muted">
        <div className="max-w-7xl mx-auto px-4">
          <div className="grid md:grid-cols-3 gap-6 mb-12">
            {PRODUCTS.map((p, i) => (
              <div key={p.term} className={`rounded-2xl p-8 border transition-all hover:-translate-y-2 duration-300 ${i === 5 ? 'bg-gradient-to-br from-primary to-[#0a1c50] border-primary teal-glow' : 'glass-card border-border'}`}>
