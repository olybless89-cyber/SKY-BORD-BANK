...
export default function DigitalBankingPage() {
  return (
    <div className="min-h-screen pt-20">
      {/* Hero */}
      <section className="py-24 bg-gradient-to-br from-[#013d36] via-[#0a0f20] to-[#0a0f20]">
        <div className="max-w-7xl mx-auto px-4 grid md:grid-cols-2 gap-12 items-center">
          ...
          <div className="glass-card rounded-3xl p-8 border border-white/10">
            <div className="bg-gradient-to-br from-primary to-[#013d36] rounded-2xl p-6 mb-4 teal-glow">
