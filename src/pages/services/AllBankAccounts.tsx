...
const ACCOUNTS = [
  { name: 'Smart Savings', apy: '4.85%', desc: 'High-yield savings with daily interest accrual and no minimum balance requirement.', features: ['4.85% APY', 'No minimum balance', 'Daily interest credit', 'Instant transfers'], color: 'from-primary to-[#0a1c50]', featured: true },
  { name: 'Premium Checking', apy: '0.50%', desc: 'Feature-rich checking account with unlimited transactions and premium debit card.', features: ['Unlimited transactions', 'Premium Visa debit', 'Cashback rewards', 'ATM fee rebates'], color: 'from-[#1a3a5c] to-[#0f172a]' },
  { name: 'Corporate Vanguard', apy: '2.10%', desc: 'Designed for business owners who need multi-user access and advanced reporting.', features: ['Multi-user access', 'Payroll integration', 'Custom reporting', 'Dedicated RM'], color: 'from-[#2d1a5c] to-[#0f172a]' },
  { name: 'Student Next-Gen', apy: '3.25%', desc: 'Zero-fee banking for students with cashback on educational purchases.', features: ['Zero monthly fees', '3.25% APY', 'Student cashback', 'Free international transfers'], color: 'from-[#1a4a2e] to-[#0f172a]' },
  { name: 'Joint Dual Checking', apy: '1.50%', desc: 'Shared account for couples and families with individual spending controls.', features: ['2 account holders', 'Individual limits', 'Family spending tracker', 'Joint debit cards'], color: 'from-[#4a2d1a] to-[#0f172a]' },
  { name: 'Fixed Capital Deposit', apy: '5.40%', desc: 'Highest yield term deposit with guaranteed returns over fixed periods.', features: ['5.40% APY guaranteed', 'Terms: 90 days–5 years', 'Capital protected', 'Auto-renewal option'], color: 'from-[#3d3a02] to-[#0f172a]', badge: 'Best Rate' },
];
