...
export default function AdminOverview() {
  ...
  const cards = stats ? [
    ...
    { label: 'Volume (USD)', value: `$${stats.total_volume.toLocaleString('en-US', { maximumFractionDigits: 0 })}`, icon: TrendingUp, color: 'text-green-400', bg: 'bg-green-400/10' },
    { label: 'Active Investments', value: stats.active_investments, icon: Clock, color: 'text-purple-400', bg: 'bg-purple-400/10' },
    { label: 'Failed Txns', value: stats.failed_transactions, icon: AlertCircle, color: 'text-red-400', bg: 'bg-red-400/10' },
  ] : [];
