      ...
      {accounts.length === 0 ? (
        ...
        <form onSubmit={handleSubmit} className="glass-card rounded-2xl p-8 border border-border space-y-6">
          ...
          <div>
            ...
            <select value={fromId} onChange={(e) => setFromId(e.target.value)} className="w-full h-12 px-4 rounded-xl bg-secondary border border-border text-foreground text-sm">
              {accounts.map((a) => (
          ...
          <div>
            ...
            <Input placeholder="e.g. SKB0012345678" value={toAccount} onChange={(e) => setToAccount(e.target.value)} className="bg-secondary border-border h-12" required />
          </div>
          ...
          <div>
            ...
            <Input placeholder="e.g. Monthly rent, Invoice #123" value={description} onChange={(e) => setDescription(e.target.value)} className="bg-secondary border-border h-12" />
          </div>
